...
function Login() {
    ...
    useEffect(() => {
        if (userInputResponse !== "") setUserInputSuccess("");
    }, [userInputResponse]);
    ...
    return (
        <>
            <Head>
                <title>Login • Bit by Bit Recipes</title>
            </Head>
            <div className="App">
                ...
                <header className="App-header">
                    <div className="relative flex items-center justify-center">
                        {/* left floating pizza */}
                        <img className="absolute left-[-60px] w-[50px] sm:w-[70px] sm:left-[-80px] animate-bounce ease-in-out [animation-duration:2s] z-10" src="/pizza.png" alt="Pizza" />
                        ...
                        <img className="absolute right-[-60px] w-[50px] sm:w-[70px] sm:right-[-80px] animate-bounce ease-in-out [animation-duration:2s] z-10" src="/pizza.png" alt="Pizza" />
                    </div>
                    ...
                    <div className="w-full sm:w-[90%] md:w-[75%] lg:w-[60%] xl:w-[45%] max-w-[800px] h-auto mt-5 mb-5 mx-auto p-5 rounded-[20px] border-8 border-solid border-[#C13D00] bg-gradient-to-b from-[#f18d5e] to-[#ef6f34]">
                        ...
                        <div className="bg-[#E65340] w-full sm:w-[90%] md:w-[75%] lg:w-[650px] h-auto m-auto p-4 rounded-[10px] border-4 border-solid border-[#C13737]">
                            <p className="text-xl sm:text-2xl md:text-3xl lg:text-[35px] mt-0 text-center">Welcome! Please enter your username and password! (:</p>
                        </div>

                        {/* button to go to create account page */}
                        <button
                            className="cursor-pointer bg-[#EB4B4B] w-full sm:w-auto h-auto flex items-center justify-center text-base sm:text-lg md:text-xl lg:text-[25px] text-white mt-5 mb-5 mx-auto px-5 py-2 rounded-[10px] border-4 border-solid border-[#B21F1F] font-['Jersey_10']"
                            type="button"
                            onClick={handleClick}
                        >
                        ...
                        <p
                            className="text-[#EB4B4B] text-[25px] font-['Jersey_10'] leading-tight whitespace-nowrap"
                            style={{
                                textShadow:
                                `-1px -1px 0 white,
                                1px -1px 0 white,
                        ...
                        <p
                            className="text-black text-[25px] font-['Jersey_10'] leading-tight whitespace-nowrap"
                            style={{
                                textShadow:
                                `-1px -1px 0 white,
                                1px -1px 0 white,
                    ...
                    <form className="flex justify-center flex-row gap-20 items-center" onSubmit={handleSubmit}>
                        {/* submit button to check user authentication*/}
                        <button
                            className="cursor-pointer bg-[#EB4B4B] w-auto h-auto flex items-center justify-center text-2xl sm:text-3xl md:text-4xl lg:text-[55px] text-[white] p-5 rounded-[20px] border-[6px] border-solid border-[#B21F1F] font-['Jersey_10']"
                            type="submit"
                        >
                            Login
                        </button>
