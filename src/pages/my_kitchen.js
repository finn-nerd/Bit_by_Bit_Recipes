...
function MyKitchen({ isLoggedIn }) {
    ...
    useEffect(() => {
        if (passwordFeedback !== "") setPasswordSuccess("");
    }, [passwordFeedback]);
            ...
            <div className="App">
                ...
                <header className="App-header">
                    <div className="relative flex items-center justify-center">
                        {/* left floating pizza */}
                        <img className="absolute left-[-60px] sm:left-[-80px] w-[50px] sm:w-[70px] animate-[float_infinite_2s] z-1" src="/pizza.png" alt="Pizza" />
                        ...
                        <div className="relative inline-block">
                            ...
                            <h1 className="absolute z-0 text-[#D35E2C] text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-[70px] whitespace-nowrap top-[0.1em] right-[0.1em] font-['Jersey_10']">
                                Bit by Bit Recipes
                            </h1>
                        </div>

                        {/* right floating pizza */}
                        <img className="absolute right-[-60px] sm:right-[-80px] w-[50px] sm:w-[70px] animate-[float_infinite_2s] z-1" src="/pizza.png" alt="Pizza" />
                    </div>
                    ...
                    <div className="w-full sm:w-[90%] md:w-[75%] lg:w-[60%] xl:w-[45%] max-w-[800px] h-auto mt-5 mb-5 mx-auto p-5 rounded-[20px] border-8 border-solid border-[#C13D00] bg-gradient-to-b from-[#f18d5e] to-[#ef6f34]">
                        ...
                        <div className="bg-[#E65340] w-full sm:w-[90%] md:w-[75%] lg:w-[650px] h-auto m-auto p-4 rounded-[10px] border-4 border-solid border-[#C13737]">
                            <p className="text-xl sm:text-2xl md:text-3xl lg:text-[35px] mt-0 text-center">Unfortunately, this page requires you to be logged in!</p>
                        </div>
                        ...
                        <div className="bg-[#EB4B4B] w-full sm:w-auto h-auto flex items-center justify-center text-base sm:text-xl md:text-2xl lg:text-3xl text-white mt-5 mb-5 mx-auto px-5 py-2 rounded-[10px] border-4 border-solid border-[#B21F1F] font-['Jersey_10']">
                            Please log in or create an account if you're new. This will let you access My Kitchen, where you can save your favorite recipes!
                        </div>

                        <div className="flex flex-row gap-20 justify-center h-20">
                            {/* Login Button */}
                            <button
                                className="bg-[#EB4B4B] w-auto h-auto flex items-center justify-center text-3xl text-[white] p-5 rounded-[20px] border-[6px] border-solid border-[#B21F1F] font-['Jersey_10']"
                                type="button"
            ...
            <div className="App min-h-screen flex flex-col">
                ...
                <div className="py-1 top-0 left-0 w-full bg-gradient-to-b from-[#F18D5E] to-[#EF6F34] z-10">
                    <div className="flex items-center my-5">
                        ...
                        {/* My Kitchen page */}
                        <h1 className="ml-auto  text-white text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-[40px] px-5 py-3 mx-10 rounded-[20px] font-['Jersey_10']">
                            My Kitchen
                        </h1>
                    </div>
                </div>
                ...
                <div className="flex flex-row flex-grow">
                    ...
                    <div className="py-1 overflow-y-auto scrollbar-hide w-[20%] bg-gradient-to-b from-[#EEAE36] to-[#E97832] z-1 flex flex-col items-center">
                        ...
                        <form autoComplete="off">
                            ...
                            <p
                                className="text-[#EB4B4B] w-[80%] mx-auto text-[20px] font-['Jersey_10'] leading-tight text-center"
                                style={{
                                    textShadow:
                                    `-1px -1px 0 white,
                                    1px -1px 0 white,
                            ...
                            <p
                                className="text-black w-[80%] mx-auto text-[20px] font-['Jersey_10'] leading-tight text-center"
                                style={{
                                    textShadow:
                                    `-1px -1px 0 white,
                                    1px -1px 0 white,
                        ...
                        <img className="my-auto w-[100px] sm:w-[120px] animate-bounce ease-in-out [animation-duration:2s]" src="/pizza.png" alt="Pizza" />
                                    ...
                                    return (
                                        ...
                                        >
                                            ...
                                            <div className="flex-1" style={{ height: "65%" }}>
                                                <img src={meal.mealThumbnail} alt={meal.mealName} className="w-full h-full object-cover rounded-t-[12px]" />
                                            </div>
                                            {/* Recipe Title */}
